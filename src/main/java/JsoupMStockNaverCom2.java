 ...
 * 유튜브에서 네이버로 공유할때
 */
public class JsoupMStockNaverCom2 {

	private static final Logger logger = LoggerFactory.getLogger(JsoupMStockNaverCom2.class);

	String strYmdhms = new SimpleDateFormat("yyyyMMdd_hhmmss", Locale.KOREAN).format(new Date());
	public final static String USER_HOME = System.getProperty("user.home");

	public static void main(String args[]) throws InterruptedException, IOException, Exception {
		new JsoupMStockNaverCom2();
	}

	JsoupMStockNaverCom2() throws IOException, Exception {
		linkShare();
	}
