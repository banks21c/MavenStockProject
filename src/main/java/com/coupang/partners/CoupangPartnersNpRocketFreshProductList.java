 ...
 * @author banks
 */
public class CoupangPartnersNpRocketFreshProductList extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpRocketFreshProductList.class);
	 ...
	 */
	public CoupangPartnersNpRocketFreshProductList() {
		initComponents();
		initList();
	}
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
	    ...
	    sb1.append("<html>\r\n");
	    sb1.append("<body>\r\n");
	    sb1.append(rocketFreshBannerHtml+"\r\n");
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersNpRocketFreshProductList.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersNpRocketFreshProductList().setVisible(true);
			}
		});
	}
