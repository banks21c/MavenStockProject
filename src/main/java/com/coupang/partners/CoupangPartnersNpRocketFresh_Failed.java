 ...
 * @author banks
 */
public class CoupangPartnersNpRocketFresh_Failed {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpRocketFresh_Failed.class);
	final static String userHome = System.getProperty("user.home");
	private URI uri = null;
	private String strUrl = "https://www.coupang.com/np/categories/393760";

	public CoupangPartnersNpRocketFresh_Failed() {
		initList();
	}
	...
	void initList() {
		try {
			...
			Logger.getLogger(CoupangPartnersNpRocketFresh_Failed.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	public static void main(String args[]) {
		CoupangPartnersNpRocketFresh_Failed coupangPartnersRocketFreshPageDownload = new CoupangPartnersNpRocketFresh_Failed();
	}
