 ...
 * @author banks
 */
public class CoupangPartnersExhibitionWholePage extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersExhibitionWholePage.class);
	final static String userHome = System.getProperty("user.home");
	private String strUrl = "https://www.coupang.com/np/exhibition";
	//브라운면도기
	private String strUrl1 = "https://pages.coupang.com/f/s299";
	 ...
	 */
	public CoupangPartnersExhibitionWholePage() {
		initComponents();
		initList();
	}
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersExhibitionWholePage.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersExhibitionWholePage().setVisible(true);
			}
		});
	}
