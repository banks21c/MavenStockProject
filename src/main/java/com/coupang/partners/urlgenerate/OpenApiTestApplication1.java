...
public final class OpenApiTestApplication1 {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(OpenApiTestApplication1.class);
...
//		getCoupangPLBrandProducts(COUPANG_PL_BRAND_URL);
		//검색 키워드에 대한 쿠팡 검색 결과와 상세 상품 정보를 생성합니다 (1 시간당 최대 10번 호출 가능합니다.)
		getSearchProducts(SEARCH_URL, "egg+slicer");
	}
	...
	public static String getShortenedUrl(String normalUrl) {
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_단축URL.html";
