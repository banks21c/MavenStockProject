...
public final class OpenApiApplication {
	...
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(OpenApiApplication.class);
...
//		getShortenedUrl("https://www.coupang.com/np/coupangglobal");
	...
	OpenApiApplication(String accessKey, String scretKey) {
	...
	public String getShortenedUrl(String normalUrl) {
		...
		try {
			...
			Logger.getLogger(OpenApiApplication.class.getName()).log(Level.SEVERE, null, ex);
		}
