...
public final class OpenApiTestApplication {
	...
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(OpenApiTestApplication.class);
...
//		getSearchProducts("egg+slicer");
	...
	public static String getShortenedUrl(String normalUrl) {
		...
		try {
			...
			Logger.getLogger(OpenApiTestApplication.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public static boolean getBestcategoryProducts(String categoryId, String categoryNm) {
	...
	public static StringBuilder getBestcategoryProducts(int idx, String categoryId, String categoryNm, int limit) {
		String bestcategoriesUrl = "";
		StringBuilder sb = new StringBuilder();
	...
	public static boolean getBestcategoryProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
		...
		for (int i = 0; i < bestCategoriesArray.length; i++) {
			...
			if (codeValue.length == 2) {
				...
				sb.append(getBestcategoryProducts(i, categoryId, categoryNm, limit));
			}
		}
		sb.append("<div>※ 파트너스 활동을 통해 일정액의 수수료를 제공받을 수 있음</div>");
	...
	public static boolean getGoldboxProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
	...
	//쿠팡 PL 상품에 대한 상세 정보를 생성합니다.
	//COUPANG_PL_URL = API_PATH + "​​/products​/coupangPL";
	public static boolean getCoupangPLProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
	...
	public static boolean getCoupangPLBrandProducts(String brandId, String brandNm) {
		String server_url = "";
		int limit = 20;
		StringBuilder sb = new StringBuilder();
	...
	public static StringBuilder getCoupangPLBrandProducts(int idx, String brandId, String brandNm, int limit) {
		String server_url;
		StringBuilder sb = new StringBuilder();
	...
	public static boolean getCoupangPLBrandProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
		...
		for (int i = 0; i < coupangPlBrandArray.length; i++) {
			...
			if (codeValue.length == 2) {
				...
				sb.append(getCoupangPLBrandProducts(i, brandId, brandNm, limit));
			}
		}
		sb.append("<div>※ 파트너스 활동을 통해 일정액의 수수료를 제공받을 수 있음</div>");
	...
	public static boolean getSearchProducts(String keyword) {
		StringBuilder sb = new StringBuilder();
...
//		server_url = server_url + "?keyword=food&limit=" + limit;
		...
		String data = getData("상품검색", searchUrl, "", strParamJson);
		sb.append(data);
		sb.append("<div>※ 파트너스 활동을 통해 일정액의 수수료를 제공받을 수 있음</div>");
