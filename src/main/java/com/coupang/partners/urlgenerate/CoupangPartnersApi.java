 ...
 * @author banks
 */
public class CoupangPartnersApi extends javax.swing.JFrame {

	private static final long serialVersionUID = 1341726937516862047L;
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersApi.class);
...
//		setDefaultDate();
	...
	// <editor-fold defaultstate="collapsed" desc="Generated
        ...
        private void initComponents() {
                ...
                jPanel14.setMinimumSize(new java.awt.Dimension(1000, 700));
                jPanel14.setPreferredSize(new java.awt.Dimension(1000, 700));
		...
		logger.debug("isLinkJCheckBoxSelected:"+isLinkJCheckBoxSelected);
                ...
                if (isJCheckBox1Selected) {
                        ...
                        if (item.contains(":")) {
                                ...
                                bResult = OpenApiTestApplication.getBestcategoryProducts(categoryId, categoryNm);
                                if (bResult) {
                                        bestcategoriesResultLbl.setText("처리 완료");
                                }
                        } else {
                                bResult = OpenApiTestApplication.getBestcategoryProducts();
                                if (bResult) {
                                        bestcategoriesResultLbl.setText("처리 완료");
                                }
                        }
                ...
                if (isGoldboxJCheckBoxSelected) {
                        bResult = OpenApiTestApplication.getGoldboxProducts();
                        if (bResult) {
                ...
                if (isCoupangPLJCheckBoxSelected) {
                        bResult = OpenApiTestApplication.getCoupangPLProducts();
                        if (bResult) {
                ...
                if (isCoupangPLBrandJCheckBoxSelected) {
                        //			OpenApiTestApplication.getCoupangPLBrandProducts();
                        ...
                        if (item.contains(":")) {
                                ...
                                bResult = OpenApiTestApplication.getCoupangPLBrandProducts(brandId, brandNm);
                                if (bResult) {
                                        coupangPLBrandResultLbl.setText("처리 완료");
                                }
                        } else {
                                bResult = OpenApiTestApplication.getCoupangPLBrandProducts();
                                if (bResult) {
                                        coupangPLBrandResultLbl.setText("처리 완료");
                                }
                        }
                ...
                if (isSearchJCheckBoxSelected) {
                        ...
                        bResult = OpenApiTestApplication.getSearchProducts(keyword);
                        if (bResult) {
                ...
                if (isClicksJCheckBoxSelected) {
                        ...
                        String strResult = OpenApiTestApplication.getReportsClicks(startDate, endDate);
                        if (!strResult.equals("")) {
                ...
                if (isOrdersJCheckBoxSelected) {
                        String startDate = strDefaultStartDate;
                        String endDate = strDefaultEndDate;
                        String strResult = OpenApiTestApplication.getReportsOrders(startDate, endDate);
                        if (!strResult.equals("")) {
                ...
                if (isCancelsJCheckBoxSelected) {
                        String startDate = strDefaultStartDate;
                        String endDate = strDefaultEndDate;
                        String strResult = OpenApiTestApplication.getReportsCancels(startDate, endDate);
                        if (!strResult.equals("")) {
                ...
                if (isLinkJCheckBoxSelected) {
                        ...
                        String shortenedUrl = OpenApiTestApplication.getShortenedUrl(linkUrl);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersApi.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersApi().setVisible(true);
			}
		});
	}
