 ...
 * @author banks
 */
public class CoupangPartnersApiOneFile extends javax.swing.JFrame {

	private static final long serialVersionUID = 1341726937516862047L;
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersApiOneFile.class);
...
//    private final static String REQUEST_JSON = "{\"coupangUrls\": [\"https://www.coupang.com/np/campaigns/82\"]}";
	 ...
	 */
	public CoupangPartnersApiOneFile() {
		initComponents();
		initList();
		initKeys();
		setDefaultDate();
	...
	public void initKeys() {
		...
		String secretKey = "";
		try {
			InputStream is = getClass().getResourceAsStream("/coupangPartners.properties");
			logger.debug("is :" + is);
			if (is != null) {
				props.load(is);
				...
				logger.debug("access key2 :" + accessKey);
				logger.debug("secret key2 :" + secretKey);
...
//			File f = new File("coupangPartners.properties");
			...
			Logger.getLogger(CoupangPartnersApiOneFile.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public String getShortenedUrl(String normalUrl) {
		...
		org.apache.http.HttpRequest request = org.apache.http.client.methods.RequestBuilder.post(DEEPLINK_URL)
	...
	public boolean getBestcategoryProducts(String categoryId, String categoryNm) {
		...
		sb.append("<div style='width:100%;'><h1>").append(strYmdBlacket).append(" ").append("카테고리별 베스트 상품( ")
			.append(categoryNm).append(") TOP").append(limit).append("</h1></div>");
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_카테고리별 베스트 상품("
			+ categoryNm + ") TOP" + limit + ".html";
	...
	public boolean getBestcategoryProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
		sb.append("<div style='width:100%;'><h1>").append(strYmdBlacket).append(" ").append("카테고리별 베스트 상품").append(limit)
			.append("</h1></div>");
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_카테고리별 베스트 상품 TOP" + limit
			+ ".html";
		FileUtil.fileWrite(strFileName, Jsoup.parse(sb.toString()).html());
		return true;
	}
	...
	public boolean getCoupangPLProducts() {
		...
		StringBuilder sb = new StringBuilder();
		sb.append("<div style='width:100%;float:left;'><h1>").append(strYmdBlacket).append(" ")
			.append("쿠팡 PL 상품 TOP").append(limit).append("</h1></div>");
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_쿠팡 PL 브랜드 별 상품 TOP"
			+ limit + ".html";
		FileUtil.fileWrite(strFileName, Jsoup.parse(sb.toString()).html());
		return true;
	}
	...
	public boolean getCoupangPLBrandProducts(String brandId, String brandNm) {
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_쿠팡 PL 브랜드 별 상품(" + brandNm
			+ ").html";
		FileUtil.fileWrite(strFileName, Jsoup.parse(sb.toString()).html());
		return true;
	}
	...
	public boolean getCoupangPLBrandProducts() {
		int limit = 20;
		StringBuilder sb = new StringBuilder();
		sb.append("<div style='width:100%;'><h1>").append(strYmdBlacket).append(" ").append("쿠팡 PL 브랜드별 상품 TOP").append(limit)
			.append("</h1></div>");
...
//		server_url = server_url + "?keyword=food&limit=" + limit;
		...
		strFileName = USER_HOME + File.separator + "documents" + File.separator + strDate + "_상품검색(" + keyword
			+ ").html";
		FileUtil.fileWrite(strFileName, Jsoup.parse(sb.toString()).html());
//		FileUtil.fileWrite(strFileName, sb.toString());
	...
	public String getData(String apiGubun, String server_url, String categoryNm, String strParamJson) {
		...
		org.apache.http.HttpHost host = org.apache.http.HttpHost.create(DOMAIN);
		org.apache.http.HttpRequest request = org.apache.http.client.methods.RequestBuilder.get(server_url)
			.setEntity(entity).addHeader("Authorization", authorization).build();
...
//							System.out.println("obj2:" + obj2.toString());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersApiOneFile.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersApiOneFile().setVisible(true);
			}
		});
	}
