...
//			    itemEls.select("a").first().attr("href", aHref);
		    ...
		    sb1.append("<a href='").append(shortenedUrl).append("' target='_blank' style='text-decoration:none'>\r\n");
		    ...
		    sb1.append("<div style='text-align:center;color:#ae0000;font-weight:bold;font-size:20px;'>").append(strSalePrice).append(strRocketFreshImg).append("</div>\r\n");
		    sb1.append("</a>\r\n");
		    sb1.append("</li>\r\n");
	    }
	    sb1.append("</ul>\r\n");
	    ...
	    strFileName = userHome + File.separator + "documents" + File.separator + strDate + "_로켓프레시.html";
