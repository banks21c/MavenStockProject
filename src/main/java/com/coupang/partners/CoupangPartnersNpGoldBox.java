 ...
 * @author banks
 */
public class CoupangPartnersNpGoldBox extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpGoldBox.class);
...
//&redirect=landing
	 ...
	 */
	public CoupangPartnersNpGoldBox() {
		initComponents();
		initList();
	}
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersNpGoldBox.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersNpGoldBox().setVisible(true);
			}
		});
	}
