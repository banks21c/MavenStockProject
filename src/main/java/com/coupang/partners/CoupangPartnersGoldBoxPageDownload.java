 ...
 * @author banks
 */
public class CoupangPartnersGoldBoxPageDownload {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersGoldBoxPageDownload.class);
	final static String userHome = System.getProperty("user.home");
	private URI uri = null;
	private String strUrl = "https://partners.coupang.com/#affiliate/ws/best/goldbox";

	public CoupangPartnersGoldBoxPageDownload() {
		initList();
	}
	...
	void initList() {
		try {
			...
			Logger.getLogger(CoupangPartnersGoldBoxPageDownload.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	public static void main(String args[]) {
		CoupangPartnersGoldBoxPageDownload coupangPartnersGoldBoxPageDownload = new CoupangPartnersGoldBoxPageDownload();
	}
