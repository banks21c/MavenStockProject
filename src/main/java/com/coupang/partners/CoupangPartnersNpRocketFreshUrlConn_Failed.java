 ...
 * @author banks
 */
public class CoupangPartnersNpRocketFreshUrlConn_Failed {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpRocketFreshUrlConn_Failed.class);
	final static String userHome = System.getProperty("user.home");
	private URI uri = null;
	private String strUrl = "https://www.coupang.com/np/categories/393760";

	public CoupangPartnersNpRocketFreshUrlConn_Failed() {
		initList();
	}
...
//			String charset = "EUC-KR";
			...
			Logger.getLogger(CoupangPartnersNpRocketFreshUrlConn_Failed.class.getName()).log(Level.SEVERE, null, ex);
		}
	...
	public static void main(String args[]) {
		CoupangPartnersNpRocketFreshUrlConn_Failed coupangPartnersGoldBoxPageDownload = new CoupangPartnersNpRocketFreshUrlConn_Failed();
	}
