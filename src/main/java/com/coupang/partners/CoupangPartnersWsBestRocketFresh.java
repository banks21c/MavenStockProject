...
public class CoupangPartnersWsBestRocketFresh {

	private static Logger logger = LoggerFactory.getLogger(CoupangPartnersWsBestRocketFresh.class);
	...
	public static void main(String[] args) {
		new CoupangPartnersWsBestRocketFresh();
	}

	CoupangPartnersWsBestRocketFresh() {
