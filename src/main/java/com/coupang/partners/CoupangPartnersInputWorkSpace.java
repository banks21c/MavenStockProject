 ...
 * @author banks
 */
public class CoupangPartnersInputWorkSpace extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersInputWorkSpace.class);
	 ...
	 */
	public CoupangPartnersInputWorkSpace() {
		initComponents();
		initList();
	}
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersInputWorkSpace.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersInputWorkSpace().setVisible(true);
			}
		});
	}
