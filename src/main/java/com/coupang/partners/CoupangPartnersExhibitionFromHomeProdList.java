 ...
 * @author banks
 */
public class CoupangPartnersExhibitionFromHomeProdList extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersExhibitionFromHomeProdList.class);
	 ...
	 */
	public CoupangPartnersExhibitionFromHomeProdList() {
		initComponents();
		initList();
	}
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
	    ...
	    Elements arrivalInfoEls = doc.select(".baby-product .price-area .delivery .arrival-info span");
	    arrivalInfoEls.attr("style", "color:#00891a;font-size:13px;");
	    ...
	    for (Element imgEl : imgEls) {
		    String strSrc = imgEl.attr("src");
		    if (strSrc.startsWith("//")) {
			    strSrc = strProtocol + ":" + strSrc;
		    }
		    imgEl.attr("src", strSrc);
		    //로켓배송,로켓와우,코인과 같은 배지가 아니고
		    //상품일 경우에 width:212px, height:21px로 한다.
		    if (!strSrc.contains("badge")) {
	    ...
	    Elements h3Els = doc.select(".promotion_category .category_name");
	    String strTitle;
	    if (h3Els.size() > 0) {
	    ...
	    sb1.append("<html>\r\n");
	    sb1.append("<body>\r\n");
	    sb1.append(exhibitionBannerHtml).append("\r\n");
	    ...
	    //아이템 목록들(id=products), /np/exhibition에서 id=productList
	    Element productListEl = doc.select("ul#products").first();
	    //아이템 목록
	    ...
	    for (int j = 0; j < itemEls.size(); j++) {
		    ...
		    itemEl.removeAttr("class");

		    itemEl.attr("style", "width:212px;height:482px;float:left;background-color: #fff; box-shadow: none; border: 1px solid #dfe1e5; border-radius: 8px; overflow: hidden; margin: 0 0 6px 0;margin-right:8px;margin-top:1px;");

		    Elements nameEls = itemEl.select(".name");
		    for (Element nameEl : nameEls) {
			    nameEl.attr("style", "display: block;display: -webkit-box;overflow: hidden;width: 100%;max-height: 48px;line-height: 16px;font-size: 12px;color: #111;-webkit-line-clamp: 3;text-overflow: ellipsis;word-wrap: break-word;text-decoration: none;");
		    }
		    ...
		    String wPcid = "2398922199897153466293";
	    ...
	    Elements productListEls = productListEl.getAllElements();
	    productListEls.removeAttr("class");
	    productListEls.removeAttr("id");
//	    for (Element el : productListEls) {
//		    el.removeAttr("class");
//	    }
	    sb1.append(productListEl.html()).append("\r\n");
	    sb1.append("</ul>\r\n");
	    sb1.append("</div>\r\n");
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersExhibitionFromHomeProdList.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersExhibitionFromHomeProdList().setVisible(true);
			}
		});
	}
