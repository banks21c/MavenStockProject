		...
		if (promotionCategoryEls != null && promotionCategoryEls.size() > 0) {
			for (Element promotionCategoryEl : promotionCategoryEls) {
				...
				productItemEls.attr("style",
						"list-style:none;width:212px;height:450px;float:left;background-color: #fff; box-shadow: none; border: 1px solid #dfe1e5; border-radius: 8px; overflow: hidden; margin: 0 0 6px 0;margin-right:8px;margin-top:1px;");
