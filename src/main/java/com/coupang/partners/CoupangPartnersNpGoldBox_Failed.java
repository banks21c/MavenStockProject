 ...
 * @author banks
 */
public class CoupangPartnersNpGoldBox_Failed {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpGoldBox_Failed.class);
	final static String userHome = System.getProperty("user.home");
	private URI uri = null;
	private String strUrl = "https://www.coupang.com/np/goldbox";

	public CoupangPartnersNpGoldBox_Failed() {
		initList();
	}
	...
	void initList() {
		try {
			...
			Logger.getLogger(CoupangPartnersNpGoldBox_Failed.class.getName()).log(Level.SEVERE, null, ex);
		}
	}

	public static void main(String args[]) {
		CoupangPartnersNpGoldBox_Failed coupangPartnersGoldBoxPageDownload = new CoupangPartnersNpGoldBox_Failed();
	}
