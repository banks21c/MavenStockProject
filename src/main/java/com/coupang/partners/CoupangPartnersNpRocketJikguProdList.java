 ...
 * @author banks
 */
public class CoupangPartnersNpRocketJikguProdList extends javax.swing.JFrame {

	private static org.slf4j.Logger logger = LoggerFactory.getLogger(CoupangPartnersNpRocketJikguProdList.class);
	 ...
	 */
	public CoupangPartnersNpRocketJikguProdList() {
		initComponents();
		initList();
	}
...
//	}// GEN-LAST:event_jRadioButton11ActionPerformed
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(CoupangPartnersNpRocketJikguProdList.class.getName()).log(java.util.logging.Level.SEVERE, null,
				ex);
		}
		// </editor-fold>
		// </editor-fold>
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new CoupangPartnersNpRocketJikguProdList().setVisible(true);
			}
		});
	}
