...
public class AllStockForeignOrganDailySimpleAll30_Thread_AIO {
	...
	public static void main(String[] args) {
		new AllStockForeignOrganDailySimpleAll30_Thread_AIO();
	}

	AllStockForeignOrganDailySimpleAll30_Thread_AIO() {
...
class AllStockForeignOrganDailySimpleAll_AIO_Thread extends Thread {
	...
	AllStockForeignOrganDailySimpleAll_AIO_Thread() {
