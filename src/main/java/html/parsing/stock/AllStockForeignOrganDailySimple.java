...
public class AllStockForeignOrganDailySimple {

	final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(AllStockForeignOrganDailySimple.class);
	...
	public static void main(String[] args) {
		new AllStockForeignOrganDailySimple(1);
//		new AllStockForeignOrganDailySimple();
	}

	AllStockForeignOrganDailySimple() {
	...
	AllStockForeignOrganDailySimple(int i) {
		// 모든 주식 정보를 조회한다.
		// 코스피
	...
	public static StockVO getStockTrade(StockVO svo) {
		try {
			...
			java.util.logging.Logger.getLogger(AllStockForeignOrganDailySimple.class.getName()).log(Level.SEVERE, null, ex);
		}
		return svo;
	}
