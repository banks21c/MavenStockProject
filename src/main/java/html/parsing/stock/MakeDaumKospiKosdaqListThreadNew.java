...
public class MakeDaumKospiKosdaqListThreadNew extends Thread {
     ...
     *
     */
    public MakeDaumKospiKosdaqListThreadNew() {
        className = this.getClass().getName();
        makeKospiKosdaqList();
    }

    public MakeDaumKospiKosdaqListThreadNew(int iType) {
        this.iType = iType;
    }

    public MakeDaumKospiKosdaqListThreadNew(int iType, long firstStartTime) {
        this.iType = iType;
    ...
    public void makeKospiKosdaqList() {
        ...
        switch (iType) {
            case 1:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSPI", "KOSPI");
                break;
            case 2:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSDAQ", "KOSDAQ");
                break;
            case 3:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSPI", "KOSPI", true);
                break;
            case 4:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSDAQ", "KOSDAQ", true);
                break;
            case 5:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSPI", "KOSPI", true, true);
                break;
            case 6:
                readMkURL(iType, "http://finance.daum.net/domestic/all_stocks?market=KOSDAQ", "KOSDAQ", true, true);
                break;
        }
    }
