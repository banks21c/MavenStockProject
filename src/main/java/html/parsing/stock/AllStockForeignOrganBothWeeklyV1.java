...
public class AllStockForeignOrganBothWeeklyV1 {

	final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(AllStockForeignOrganBothWeeklyV1.class);
	...
	public static void main(String[] args) {
		new AllStockForeignOrganBothWeeklyV1();
	}

	AllStockForeignOrganBothWeeklyV1() {
		 test();
//		real();
	}
...
//		List<StockVO> kospiStockList = readOne("005930", "삼성전자");
		List<StockVO> kospiStockList = readOne("009830", "한화솔루션");
