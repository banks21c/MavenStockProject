...
public class OnlyURLDecodeTest{

	private static Logger logger = LoggerFactory.getLogger(OnlyURLDecodeTest.class);
	...
	public static void main(String[] args) {
		new OnlyURLDecodeTest(1);
	}

	public OnlyURLDecodeTest() {
	}

	public OnlyURLDecodeTest(int i) {
