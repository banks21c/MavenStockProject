 ...
 *
 */
public class MakeKospiKosdaqList2 {
     ...
     *
     */
    public MakeKospiKosdaqList2(int i) {
        isKonex("066570");
        isKonex("048870");
        isKonex("219420");
    }
    ...
    public static void makeKospiKosdaqList() {
        ...
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=P", "KOSPIDAQ");
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=Q", "KOSPIDAQ");
    ...
    public static Hashtable<String, String> readMkURL(String url, String div, boolean excludeWoosun,
        ...
        try {
            ...
            Elements edds = doc.select(".st2 a");
