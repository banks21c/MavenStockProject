 ...
 * 유튜브에서 네이버로 공유할때
 */
public class JsoupMkStockAfterHours2 {

	private static final Logger logger = LoggerFactory.getLogger(JsoupMkStockAfterHours2.class);

	static String strYmdhms = new SimpleDateFormat("yyyyMMdd_hhmmss", Locale.KOREAN).format(new Date());
	public final static String USER_HOME = System.getProperty("user.home");

	public static void main(String args[]) throws InterruptedException, IOException, Exception {
		new JsoupMkStockAfterHours2();
	}

	JsoupMkStockAfterHours2() throws IOException, Exception {
		StockVO svo = new StockVO();
		svo.setStockCode("019550");
