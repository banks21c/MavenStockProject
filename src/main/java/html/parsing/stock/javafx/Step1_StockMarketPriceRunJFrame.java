...
public class Step1_StockMarketPriceRunJFrame extends javax.swing.JFrame {
	 ...
	 */
	public Step1_StockMarketPriceRunJFrame() {
		initComponents();
//		execute();
	}
...
//		NaverUtil.naverBlogLinkShare(strNidAut, strNidSes, strShareUrl, strShareTitle, strCategoryName, contentSb, rootPane);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Step1_StockMarketPriceRunJFrame.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Step1_StockMarketPriceRunJFrame().setVisible(true);
			}
		});
	}
