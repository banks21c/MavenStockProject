...
//					stock.setSpecialLetter(text);
					curPriceWithComma = span1.text();
					curPriceWithoutComma = curPriceWithComma.replace(",", "");
					...
					logger.debug("curPriceWithoutComma :" + curPriceWithoutComma);
