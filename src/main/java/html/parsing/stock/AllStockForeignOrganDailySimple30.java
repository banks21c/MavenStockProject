...
public class AllStockForeignOrganDailySimple30 {

	final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(AllStockForeignOrganDailySimple30.class);
	...
	public static void main(String[] args) {
		new AllStockForeignOrganDailySimple30(1);
//		new AllStockForeignOrganDailySimple();
	}

	AllStockForeignOrganDailySimple30() {
	...
	AllStockForeignOrganDailySimple30(int i) {
		// 모든 주식 정보를 조회한다.
		// 코스피
		...
		writeFile(kospiAllStockList, kospiAllStockListCopy, "일간(Daily) 코스피 외국인 순매매(거래대금순)", "외국인", "거래대금");
		writeFile(kosdaqAllStockList, kosdaqAllStockListCopy, "일간(Daily) 코스닥 외국인 순매매(거래대금순)", "외국인", "거래대금");
		...
		writeFile(kospiAllStockList, kospiAllStockListCopy, "일간(Daily) 코스피 기관 순매매(거래대금순)", "기관", "거래대금");
		writeFile(kosdaqAllStockList, kosdaqAllStockListCopy, "일간(Daily) 코스닥 기관 순매매(거래대금순)", "기관", "거래대금");
	...
	public static StockVO getStockTrade(StockVO svo) {
		try {
			...
			java.util.logging.Logger.getLogger(AllStockForeignOrganDailySimple30.class.getName()).log(Level.SEVERE, null, ex);
		}
		return svo;
	}
