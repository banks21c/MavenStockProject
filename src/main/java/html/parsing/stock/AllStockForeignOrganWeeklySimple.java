...
public class AllStockForeignOrganWeeklySimple {

	final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(AllStockForeignOrganWeeklySimple.class);
	...
	public static void main(String[] args) {
		new AllStockForeignOrganWeeklySimple(1);
//		new AllStockForeignOrganWeeklySimple();
	}

	AllStockForeignOrganWeeklySimple() {
	...
	AllStockForeignOrganWeeklySimple(int i) {
		// 모든 주식 정보를 조회한다.
		// 코스피
	...
	public static StockVO getStockTrade(StockVO svo) {
		try {
			...
			java.util.logging.Logger.getLogger(AllStockForeignOrganWeeklySimple.class.getName()).log(Level.SEVERE, null, ex);
		}
		return svo;
	}
