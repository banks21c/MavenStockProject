 ...
 *
 */
public class MakeDaumKospiKosdaqList {
     ...
     *
     */
    public MakeDaumKospiKosdaqList(int i) {
        isKonex("066570");
        isKonex("048870");
        isKonex("219420");
    }
    ...
    public MakeDaumKospiKosdaqList() {
    ...
    public static void makeKospiKosdaqList() {
        ...
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=P", "KOSPI");
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=Q", "KOSDAQ");

        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=P", "KOSPI", true);
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=Q", "KOSDAQ", true);

        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=P", "KOSPI", true, true);
        readMkURL("http://finance.daum.net/quote/all.daum?type=U&stype=Q", "KOSDAQ", true, true);

        long endTime = System.currentTimeMillis();
        String elapsedTimeSecond = (endTime - startTime) / 1000 + "초";
        String elapsedTimeMinute = (endTime - startTime) / 1000 / 60 + "분";
        String elapsedTimeHour = (endTime - startTime) / 1000 / 60 / 60 + "시간";
        String elapsedTimeDay = (endTime - startTime) / 1000 / 60 / 60 / 24 + "일";
        System.out.println("초:" + elapsedTimeSecond);
        System.out.println("초:" + elapsedTimeMinute);
        System.out.println("초:" + elapsedTimeHour);
        System.out.println("초:" + elapsedTimeDay);
        System.out.println(elapsedTimeDay + elapsedTimeHour + elapsedTimeMinute + elapsedTimeSecond);
