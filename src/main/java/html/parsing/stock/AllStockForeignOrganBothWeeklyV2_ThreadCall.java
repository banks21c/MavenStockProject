...
public class AllStockForeignOrganBothWeeklyV2_ThreadCall {

	AllStockForeignOrganBothWeeklyV2_Thread thread1 = null;
	AllStockForeignOrganBothWeeklyV2_Thread thread2 = null;
	...
	public static void main(String[] args) {
		new AllStockForeignOrganBothWeeklyV2_ThreadCall();
	}

	AllStockForeignOrganBothWeeklyV2_ThreadCall() {
		// 주간 거래일을 알아낸다.
		getFirstLastDayOfWeek();

		thread1 = new AllStockForeignOrganBothWeeklyV2_Thread("코스피", iFirstDayOfWeek, iLastDayOfWeek);
		thread1.start();

		thread2 = new AllStockForeignOrganBothWeeklyV2_Thread("코스닥", iFirstDayOfWeek, iLastDayOfWeek);
		thread2.start();
	...
	public class AllStockForeignOrganBothWeeklyV2_Thread extends Thread {

		final String USER_HOME = System.getProperty("user.home");
		private Logger logger = LoggerFactory.getLogger(AllStockForeignOrganBothWeeklyV2_Thread.class);
		...
		AllStockForeignOrganBothWeeklyV2_Thread(String marketType, int iFirstDayOfWeek, int iLastDayOfWeek) {
