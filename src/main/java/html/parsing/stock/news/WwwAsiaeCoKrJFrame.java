...
public class WwwAsiaeCoKrJFrame extends javax.swing.JFrame {

	public final static String USER_HOME = System.getProperty("user.home");
	private static final long serialVersionUID = -7679886776886295504L;
	private static Logger logger = LoggerFactory.getLogger(WwwAsiaeCoKrJFrame.class);
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new WwwAsiaeCoKrJFrame().setVisible(true);
			}
		});
	}

	public WwwAsiaeCoKrJFrame() {
