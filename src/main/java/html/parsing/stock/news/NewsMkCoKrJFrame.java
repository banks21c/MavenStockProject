...
public class NewsMkCoKrJFrame extends javax.swing.JFrame {

	public final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(NewsMkCoKrJFrame.class);
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new NewsMkCoKrJFrame().setVisible(true);
			}
		});
	}

	public NewsMkCoKrJFrame() {
		logger = LoggerFactory.getLogger(this.getClass());
		initComponents();
	}
