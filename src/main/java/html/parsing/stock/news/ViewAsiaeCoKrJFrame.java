...
public class ViewAsiaeCoKrJFrame extends javax.swing.JFrame {

	public final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(ViewAsiaeCoKrJFrame.class);
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new ViewAsiaeCoKrJFrame().setVisible(true);
			}
		});
	}

	public ViewAsiaeCoKrJFrame() {
