...
public class WwwMtCoKrJFrame extends javax.swing.JFrame {

	public final static String USER_HOME = System.getProperty("user.home");
	private static final long serialVersionUID = 1L;
	private static Logger logger = LoggerFactory.getLogger(WwwMtCoKrJFrame.class);
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new WwwMtCoKrJFrame().setVisible(true);
			}
		});
	}

	public WwwMtCoKrJFrame() {
