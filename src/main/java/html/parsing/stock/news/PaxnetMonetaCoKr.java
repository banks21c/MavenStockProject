...
public class PaxnetMonetaCoKr extends News implements NewsInterface {

	private static Logger logger = LoggerFactory.getLogger(PaxnetMonetaCoKr.class);
	...
	public StringBuilder createHTMLFile(String url, String strMyComment) {
		...
		try {
			...
			strTitle = doc.select(".report-view-tit h1").html();
			System.out.println("title:" + strTitle);
			strTitleForFileName = strTitle;
			strTitleForFileName = StockUtil.getTitleForFileName(strTitleForFileName);
			System.out.println("strTitleForFileName:" + strTitleForFileName);

			strDate = doc.select(".report-view .report-view-tit .writer .date").get(0).text();
			...
			Elements article = doc.select(".report-view-cont");
