...
public class NewsJTBC extends News {

    private static Logger logger = LoggerFactory.getLogger(NewsJTBC.class);
    ...
    public static StringBuilder createHTMLFile(String url) {
        ...
        try {
            ...
            Element timeElement = doc.select(".artical_date .i_date").get(0);
