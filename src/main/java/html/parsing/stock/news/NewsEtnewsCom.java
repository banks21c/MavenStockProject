...
public class NewsEtnewsCom extends News implements NewsInterface {

	private static Logger logger = LoggerFactory.getLogger(NewsEtnewsCom.class);
	...
	public StringBuilder createHTMLFile(String url, String strMyComment) {
		...
		try {
			...
			strTitle = doc.select(".article_title").html();
			System.out.println("title:" + strTitle);
			strTitleForFileName = strTitle;
			strTitleForFileName = StockUtil.getTitleForFileName(strTitleForFileName);
			System.out.println("strTitleForFileName:" + strTitleForFileName);

			strDate = doc.select("article .date").text();
