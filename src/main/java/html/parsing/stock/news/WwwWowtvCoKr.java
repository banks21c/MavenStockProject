...
public class WwwWowtvCoKr extends javax.swing.JFrame {

    private static Logger logger = LoggerFactory.getLogger(WwwWowtvCoKr.class);
    ...
    public WwwWowtvCoKr(String url) {
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new WwwWowtvCoKr().setVisible(true);
            }
        });
    }
...
//            JsoupChangeScriptSrcElementsAttribute.changeScriptSrcElementsAttribute(doc, protocol, host, path);
            ...
            Elements title = doc.select(".news-header-section .title-area .title-news");
            ...
            Element authorEl = doc.select(".info-reporter").get(0);
            String strAuthor = authorEl.html();
            if (strAuthor.equals("")) {
...
//            Elements contentElements = doc.select(".box-news-body");
            ...
            System.out.println("fileName1:" + userHome + File.separator + "documents" + File.separator + host + File.separator + strFileNameDate + "_" + strTitleForFileName + ".html");
