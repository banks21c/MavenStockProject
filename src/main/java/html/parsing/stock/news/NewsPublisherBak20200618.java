...
enum NewsPublisherBak20200618 {
	...
	private NewsPublisherBak20200618(String name) { //enum에서 생성자 같은 역할
		this.name = name;
	}
	...
	public static void main(String args[]) {
		for (NewsPublisherBak20200618 np : NewsPublisherBak20200618.values()) {
