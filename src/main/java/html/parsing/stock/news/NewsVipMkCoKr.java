...
public class NewsVipMkCoKr extends javax.swing.JFrame {

    private static Logger logger = LoggerFactory.getLogger(NewsVipMkCoKr.class);
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new NewsVipMkCoKr().setVisible(true);
            }
        });
    }

    public NewsVipMkCoKr() {
    ...
    public static StringBuilder createHTMLFile(String url) {
        ...
        try {
            ...
            Elements title = doc.select("div#Titless");
            ...
            String strDate = title.get(0).parent().nextElementSibling().text();
            ...
            Elements strConts = doc.select("div#Conts");
