...
public class WwwAsiaeCoKr extends News implements NewsInterface {
...
////	logger.debug("doc:[" + doc + "]");
	...
	public StringBuilder createHTMLFileCommon(Document doc, String strUrl, String strMyComment) {
		...
		contentEls.select("span#layerPop").remove();
...
//		strContent = strContent.replace("<span>", "");
//		strContent = strContent.replace("</span>", "");
