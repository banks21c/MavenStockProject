...
public class WwwSedailyComJFrame extends javax.swing.JFrame {
	...
	public WwwSedailyComJFrame() {
		logger = LoggerFactory.getLogger(this.getClass());

		initComponents();
	}

	WwwSedailyComJFrame(int i) {
		logger = LoggerFactory.getLogger(this.getClass());
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new WwwSedailyComJFrame().setVisible(true);
			}
		});
	}
	...
	public StringBuilder createHTMLFile(String url, String strMyComment) {
		logger = LoggerFactory.getLogger(WwwSedailyComJFrame.class.getName());
