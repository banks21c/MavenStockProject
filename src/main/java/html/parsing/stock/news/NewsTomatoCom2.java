...
public class NewsTomatoCom2 extends javax.swing.JFrame {
    ...
    private static Logger logger = LoggerFactory.getLogger(NewsTomatoCom2.class);
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new NewsTomatoCom2().setVisible(true);
            }
        });
    }

    public NewsTomatoCom2() {
    ...
    public static StringBuilder createHTMLFile(String url) {
        ...
        try {
            ...
            if (strAuthor.equals("")) {
                strAuthor = doc.select("#cc_textarea div").last().text();
            }
            ...
            if (rn_sdates.size() > 0) {
                ...
                String strDate = rn_sdate.childNode(0).toString().trim();
            ...
            Elements contentElements = doc.select("#cc_textarea table");
