...
public class SedailyComJFrame extends javax.swing.JFrame {
	...
	public SedailyComJFrame() {
		logger = LoggerFactory.getLogger(this.getClass());

		initComponents();
	}

	SedailyComJFrame(int i) {
		logger = LoggerFactory.getLogger(this.getClass());
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new SedailyComJFrame().setVisible(true);
			}
		});
	}
	...
	public StringBuilder createHTMLFile(String url, String strMyComment) {
		logger = LoggerFactory.getLogger(SedailyComJFrame.class.getName());
