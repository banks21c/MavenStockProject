...
public class VipMkCoKrJFrame extends javax.swing.JFrame {

	public final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(VipMkCoKrJFrame.class);
...
//	String strUrl = "http://vip.mk.co.kr/newSt/news/news_view.php?p_page=&sCode=122&t_uid=22&c_uid=136511&topGubun=";
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new VipMkCoKrJFrame().setVisible(true);
			}
		});
	}

	public VipMkCoKrJFrame() {
