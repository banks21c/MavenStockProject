...
public class NewsKhanCoKr extends News implements NewsInterface {

	private static Logger logger = LoggerFactory.getLogger(NewsKhanCoKr.class);
	...
	public StringBuilder createHTMLFile(String url, String strMyComment) {
		...
		try {
			...
			strDate = doc.select(".art_header .byline em").text();
