...
public class StockAsiaeCoKr extends javax.swing.JFrame {

    private static Logger logger = LoggerFactory.getLogger(StockAsiaeCoKr.class);
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new StockAsiaeCoKr().setVisible(true);
            }
        });
    }

    public StockAsiaeCoKr() {
