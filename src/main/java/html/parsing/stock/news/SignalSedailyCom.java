...
public class SignalSedailyCom extends javax.swing.JFrame {
	...
	public SignalSedailyCom() {
		logger = LoggerFactory.getLogger(this.getClass());

		initComponents();
	}

	SignalSedailyCom(int i) {
		logger = LoggerFactory.getLogger(this.getClass());

		String url = JOptionPane.showInputDialog(this.getClass().getSimpleName() + " URL을 입력하여 주세요.");
		System.out.println("url:[" + url + "]");
		if (StringUtils.defaultString(url).equals("")) {
			url = "https://signal.sedaily.com/NewsView/1Z5GT0M4YZ/GX11";
		}
		createHTMLFile(url);
	}
	...
	public static void main(String[] args) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			public void run() {
				new SignalSedailyCom().setVisible(true);
			}
		});
	}
	...
	public static StringBuilder createHTMLFile(String url, String strMyComment) {
		logger = LoggerFactory.getLogger(SignalSedailyCom.class.getName());
