...
public class YoutubeList {
    ...
    private static Logger logger = LoggerFactory.getLogger(YoutubeList.class);
    ...
    public StringBuilder writeFile(String url) {
        ...
        try {
            ...
            String title = doc.select(".pl-header-title").text();
            title = title.replaceAll(" ", "_");
            title = title.replaceAll("\"", "'");
            System.out.println("title:" + title);
            String headTitle = doc.select(".pl-header-title").text();
            String publisher = doc.select(".pl-header-details li").get(0).html();
            publisher = publisher.replace("href=\"/", "href=\"https://www.youtube.com/");
