...
public class AllStockForeignOrganWeekly {

	final static String USER_HOME = System.getProperty("user.home");
	private static Logger logger = LoggerFactory.getLogger(AllStockForeignOrganWeekly.class);
	...
	public static void main(String[] args) {
		new AllStockForeignOrganWeekly(1);
	}

	AllStockForeignOrganWeekly() {

		List<StockVO> kospiStockList = readOne("005930", "삼성전자");
		kospiStockList = getAllStockInfo(kospiStockList);
		writeFile(kospiStockList, "코스피", "외국인", "거래대금");
	}

	AllStockForeignOrganWeekly(int i) {
		// 모든 주식 정보를 조회한다.
		// 코스피
		...
		writeFile(kospiAllStockList, "주간(Weekly) 코스피 외국인 거래량", "외국인", "거래량");
		writeFile(kosdaqAllStockList, "주간(Weekly) 코스닥 외국인 거래량", "외국인", "거래량");
		...
		writeFile(kospiAllStockList, "주간(Weekly) 코스피 외국인 순매매(거래대금순)", "외국인", "거래대금");
		writeFile(kosdaqAllStockList, "주간(Weekly) 코스닥 외국인 순매매(거래대금순)", "외국인", "거래대금");
		...
		writeFile(kospiAllStockList, "주간(Weekly) 코스피 기관 거래량", "기관", "거래량");
		writeFile(kosdaqAllStockList, "주간(Weekly) 코스닥 기관 거래량", "기관", "거래량");
		...
		writeFile(kospiAllStockList, "주간(Weekly) 코스피 기관 순매매(거래대금순)", "기관", "거래대금");
		writeFile(kosdaqAllStockList, "주간(Weekly) 코스닥 기관 순매매(거래대금순)", "기관", "거래대금");
	...
	public static StockVO getStockTrade(StockVO svo) {
		try {
			...
			java.util.logging.Logger.getLogger(AllStockForeignOrganWeekly.class.getName()).log(Level.SEVERE, null, ex);
		}
		return svo;
	}
