...
public class StockMarketPriceRunJobJFrame extends javax.swing.JFrame {
	 ...
	 */
	public StockMarketPriceRunJobJFrame() {
		initComponents();
//		execute();
	}

	public StockMarketPriceRunJobJFrame(String strNidAut, String strNidSes) {
...
//		new StockPlusMinusDivide_ThreadCall(strNidAut,strNidSes).start();
	...
	public void start2() {
		...
		StockMarketPriceRunJob runJob = new StockMarketPriceRunJob(strNidAut,strNidSes);
...
//		job = newJob(StockPlusMinusDivide100Job.class).withIdentity("job0", "group0").build();
			job = newJob(runJob.getClass()).withIdentity("job0", "group0").build();
			trigger = newTrigger().withIdentity("trigger0", "group0").withSchedule(cronSchedule("0 */5 * ? * *"))
					.build();
			sched.scheduleJob(job, trigger);

			// Job #1 is scheduled to run every day at 15:40pm
			job = newJob(runJob.getClass()).withIdentity("job1", "group1").build();
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(StockMarketPriceRunJobJFrame.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new StockMarketPriceRunJobJFrame().setVisible(true);
			}
		});
	}
